  ...
  return (
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          <strong>Lok Terms of Service</strong> 
          <br /><br />

          Effective: February 24, 2021
          <br /><br />

          <u>If you use this storage system, that means you agree to these <strong>Terms of Service </strong>detailed below.</u>
          <br /><br />

          Thanks for using Lok! Our mission is to create a more direct way of working by providing a platform to keep your content safe and accessible. These terms of service (“<strong>Terms</strong>”) cover your use and access to our service ("<strong>Service</strong>"). This agreement applies worldwide, regardless of geological location. Our <Link to='/privacy-policy' target='_blank'>Privacy Policy</Link> explains how we collect and use your information while our <Link to='/acceptable-use' target='_blank'>Acceptable Use Policy</Link> outlines your responsibilities when using our Service. <u>By using our Service, you’re agreeing to be bound by these Terms, our <Link to='/privacy-policy' target='_blank'>Privacy Policy</Link>, and <Link to='/acceptable-use' target='_blank'>Acceptable Use Policy</Link>.</u>
          <br /><br />

          <strong>Your Things & Your Permissions</strong>
          <br /><br />

          When you use our Service, you provide us with stuff like your files, content, gists, and so on (“<strong>Your Things</strong>”). Your Things are yours. These Terms don’t give us any rights to Your Things except for the limited rights that enable us to offer this Service.
          <br /><br />
          We need your permission to do stuff like hosting Your Things and sharing them when you ask us to. Our Service also provides you document / image / video previews. To provide these and other features, Lok accesses, stores, and scans Your Things. You give us permission to do that, and this permission extends to our affiliates and trusted third parties we work with.
          <br /><br />

          <strong>Your Responsibilities</strong>
          <br /><br />

          Your use of our Service must comply with our <Link to='/acceptable-use' target='_blank'>Acceptable Use Policy</Link>. Content in this Service may be protected by others’ intellectual property rights. Please don’t copy, upload, download, or share content unless you have the right to do so.
          <br /><br />
          Lok may review your conduct and content for compliance with these Terms and our <Link to='/acceptable-use' target='_blank'>Acceptable Use Policy</Link>. <u>We aren’t responsible for the content people post and share via this Service.</u>
          <br /><br />
          Help us keep Your Things protected. Safeguard your password to the Service, and keep your account information current. Don’t share your account credentials or give others access to your account.
          <br /><br />
          You may use our Service only as permitted by applicable law, including export control laws and regulations. Finally, to use our Service, you must be at least 13 (or older, depending on where you live).
          <br /><br />

          <strong>Termination</strong>
          <br /><br />

          You’re free to stop using our Service at any time. We reserve the right to suspend or terminate your access to the Services without notice to you if:
        </Card.Text>

        <ListGroup variant='flush'>
          <ListGroup.Item>(a) you’re in breach of these Terms,</ListGroup.Item>
          <ListGroup.Item>(b) your use of the Service would cause a real risk of harm or loss to us or other users, or</ListGroup.Item>
          <ListGroup.Item>(c) you haven't accessed our Service for 12 consecutive months.</ListGroup.Item>
        </ListGroup>
        <br /><br />

        <Card.Text>
          In special cases, we may send some notification to let you know that your account is scheduled for termination, but that is solely at the discretion of Lok. We absolutely will not provide notice before termination where:
        </Card.Text>
